...
public class PesquisaAluguelBean implements Serializable {
	...
	public void pesquisar() {
		this.alugueis = this.aluguelDAO.buscarPorDataDeEntregaEModeloCarro(this.aluguel.getDataEntrega(), this.carro.getModelo());
	}
	
	public void pesquisarCriteria() {
		this.alugueis = this.aluguelDAO.buscarPorDataDeEntregaEModeloCarroCriteria(this.aluguel.getDataEntrega(), this.carro.getModelo());
	}	
